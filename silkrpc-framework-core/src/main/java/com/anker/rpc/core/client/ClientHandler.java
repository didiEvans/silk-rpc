...
public class ClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        RpcInvocation rpcInvocation = CommonClientCache.CLIENT_SERIALIZE_FACTORY.deserialize(reqContent, RpcInvocation.class);
        if (ObjectUtil.isNotNull(rpcInvocation.getE())){
